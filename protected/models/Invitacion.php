 ...
 *
 * The followings are the available columns in table '{{invitacion}}':
 * @property integer $id
...
class Invitacion extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array('user_id, email_invitado, request_id, fecha, estado', 'required'),
            array('user_id', 'numerical', 'integerOnly'=>true),
            array('email_invitado, request_id', 'length', 'max'=>150),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, user_id, email_invitado, request_id, fecha, estado', 'safe', 'on'=>'search'),
        );
    }
