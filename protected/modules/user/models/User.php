...
class User extends CActiveRecord
{
	...
	public function rules() 
	{
		...
		return ((get_class(Yii::app())=='CConsoleApplication' || (get_class(Yii::app())!='CConsoleApplication' && Yii::app()->getModule('user')->isAdmin()))?array(
			...
			array('cedula', 'unique', 'message' => 'Esta cedula de identidad ya está siendo utilizada.'),
			...
			array('username, email, superuser, fecha_nacimiento, status, cedula, ciudad', 'required'),
			array('superuser, status', 'numerical', 'integerOnly'=>true),
			array('id, username, password, email, activkey, create_at, lastvisit_at, superuser, status, puntos, fecha_nacimiento, twitter, twitter_id, nombre,oauth_token, oauth_token_secret, puntos, cedula, ciudad', 'safe', 'on'=>'search'),
